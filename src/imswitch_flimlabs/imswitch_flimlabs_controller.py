...
from imswitch.imcontrol.controller.basecontrollers import ImConWidgetController,LiveUpdatedController
...
class imswitch_flimlabs_controller(ImConWidgetController):
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            self._logger.warning("No positioner found")
